...
namespace VRStandardAssets.Flyer
{
    ...
    public class EnvironmentController : MonoBehaviour
    {
        ...
        [SerializeField] private float m_EnemySpawnFrequency = 3f;          // The time between enemies spawning in seconds.
        ...
        [SerializeField] private float m_EnemySpawnZoneRadius = 120f;       // The radius of the sphere in which the enemies spawn.
        ...
        [SerializeField] private ObjectPool m_EnemyObjectPool;              // The object pool that stores the enemies.
        ...
        public void StartEnvironment()
        {
            ...
            // Start spawning asteroids, enemies and rings.
        ...
        private void SpawnAsteroid ()
        {
            ...
            // Generate a position at a distance forward from the camera within a random sphere circumference and put the asteroid at that position.
            float angle = Random.Range(0, 360);
            Vector3 randomCircle = new Vector3(Mathf.Cos(angle * Mathf.Deg2Rad), Mathf.Sin(angle * Mathf.Deg2Rad), 0);
            Vector3 asteroidPosition = m_Cam.position + Vector3.forward * m_SpawnZoneDistance + randomCircle * m_AsteroidSpawnZoneRadius;
        ...
        private void SpawnEnemy()
        {
            ...
            GameObject enemyGameObject = m_EnemyObjectPool.GetGameObjectFromPool();

            // Generate a position at a distance forward from the camera within a random sphere and put the enemy at that position.
            Vector3 enemyPosition = m_Cam.position + Vector3.forward * m_SpawnZoneDistance + Random.insideUnitSphere * m_EnemySpawnZoneRadius;
            enemyGameObject.transform.position = enemyPosition;
        }

        private IEnumerator SpawnEnemyRoutine()
        {
            // With an initial delay, spawn a enemy and delay whilst the environment is spawning.
